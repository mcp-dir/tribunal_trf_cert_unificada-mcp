...
Tribunal TRF: Certidão Unificada da Justiça Federal segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [tribunal_trf_cert_unificada@mcp.ai](mailto:tribunal_trf_cert_unificada@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
